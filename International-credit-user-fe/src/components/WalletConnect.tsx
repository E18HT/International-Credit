...
export const WalletConnect = () => {
  ...
  const handleConnect = async (connectorId: string) => {
    if (!user?.emailVerified) {
      toast.error("Please verify your email to connect your wallet.");
      return;
    }
    try {
        ...
        <DropdownMenuTrigger asChild>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="">{shortAddress}</span>
            </div>
      ...
      {!user?.emailVerified ? (
        <>
          <Alert variant="destructive">
            <AlertDescription>
              You have received an email verification link. please verify your
              email to connect your wallet.
            </AlertDescription>
          </Alert>
        </>
      ) : (
