...
export const generateFCMToken = async (): Promise<string | null> => {
  ...
  try {
    ...
    if (permission !== "granted") {
      throw new Error(
        "Please enable notifications in your browser settings to receive important updates. You can do this by clicking the notification icon in your browser's address bar or going to Site Settings > Notifications."
      );
    }
